      ...
      <main id="main-content">
        ...
        <footer className="footer" role="contentinfo">
          <div className="footer-inner">
            <p className="footer-copy">&copy; {new Date().getFullYear()} ilham saputra</p>
            <div className="footer-socials">
              {/* Instagram */}
              <a
                href="https://www.instagram.com/ilhammsptra_/"
                target="_blank"
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@ninetofive925"
                target="_blank"
                rel="noopener noreferrer"
                className="social-glass-btn"
                aria-label="TikTok"
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/ilham-saputra-61003b32a/"
                target="_blank"
                rel="noopener noreferrer"
                className="social-glass-btn"
                aria-label="LinkedIn"
              ...
              {/* GitHub */}
              <a
                href="https://github.com/ilhamsptr1"
                target="_blank"
                rel="noopener noreferrer"
                className="social-glass-btn"
                aria-label="GitHub"
